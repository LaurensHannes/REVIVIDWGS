...
bam.map{id,chr,bam,bai -> tuple(chr,tuple(id,bam,bai))}.groupTuple().flatten().collate( 10 ).map{chr,id1,bam1,bai1,id2,bam2,bai2,id3,bam3,bai3 -> chr,tuple(id1,bam1,bai1),tuple(id2,bam2,bai2),tuple(id3,bam3,bai3))}.view()
