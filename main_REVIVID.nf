...
bam.map{id,chr,bam,bai -> tuple(id,chr,tuple(bam,bai))}.join(crossedped_ch,by: [0,1], remainder: true).join(crossedped_ch,by: [3,4], remainder: true).join(crossedped_ch,by: [6,7], remainder: true).view()
