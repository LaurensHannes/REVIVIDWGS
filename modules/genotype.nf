process genotype {
	...
	myDir.mkdirs()
        ...
        gatk HaplotypeCaller --verbosity INFO -ploidy $ploidy -L ${chr}.bed -R $genome -I $bam -O ${id}.${chr}.deepmosaic.vcf --sequence-dictionary ${dict}  --native-pair-hmm-threads ${task.cpus}
