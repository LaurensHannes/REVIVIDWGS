...
deepmosaic-draw -i input.txt -o ./ -a ${programpath}/annovar/ -b hg38 -db  hg38_gnomad30_genome.txt
deepmosaic-predict feature.txt  -o ${id}.${chr}.deepmosaic.txt -m efficientnet-b4_epoch_6.pt -b 10 -gb hg38
"""
