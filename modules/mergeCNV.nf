process mergeCNV{ 
		...
		survivor filter ${vcf1} ${lowmq1}.bed 25 -1 0 -1 ${vcf1}.filterd.vcf
		survivor filter ${vcf2} ${lowmq2}.bed 25 -1 0 -1 ${vcf2}.filterd.vcf
		survivor filter ${vcf3} ${lowmq3}.bed 25 -1 0 -1 ${vcf3}.filterd.vcf
